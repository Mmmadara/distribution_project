...
public class UserService {
    ...
    public UserService(UserRepo userRepo, OrganizationRepo orgRepo, RoleRepo roleRepo, EmailTokenRepo tokenRepo, MailSenderService mailSender, BCryptPasswordEncoder encoder) {
    ...
    public void activateUser(LoginDTO loginDTO, String token) throws Exception {
